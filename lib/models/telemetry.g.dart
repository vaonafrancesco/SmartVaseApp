...
_$TelemetryImpl _$$TelemetryImplFromJson(Map<String, dynamic> json) =>
    _$TelemetryImpl(
      ...
      pressureHpa: (json['pressure_hpa'] as num?)?.toInt(),
      temperatureC: (json['temperature_c'] as num?)?.toInt(),
      gasResistanceOhms: (json['gas_resistance_ohms'] as num?)?.toInt(),
      ...
      waterLevelCm: (json['water_level_cm'] as num?)?.toDouble(),
...
Map<String, dynamic> _$$TelemetryImplToJson(_$TelemetryImpl instance) =>
    <String, dynamic>{
      ...
      'gas_resistance_ohms': instance.gasResistanceOhms,
      'soil_moisture': instance.soilMoisture,
      'distancesCm': instance.distancesCm,
      'water_level_cm': instance.waterLevelCm,
